        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">注册</h2>
                </div>
            </div>
            <div class="col-12">
...
<!-- product tab start 这里是注册的地方，很多id得改-->
<div class="my-account pb-70">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title text-capitalize pb-30"> 注册账号</h3>
                <form class="log-in-form" method="post" action="register">
                    <div class="form-group row">
                        <label for="customer_id" class="col-md-3 col-form-label">用户名</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="customer_id" name="customer_id">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="customer_name" class="col-md-3 col-form-label">昵称</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="customer_pwd" class="col-md-3 col-form-label">密码</label>
                        <div class="col-md-6">
                            <div class="input-group mb-2 mr-sm-2">
                                <input type="password" class="form-control" id="customer_pwd" name="customer_pwd">
                                <div class="input-group-prepend">
                                    <!-- <button type="button" class="input-group-text  theme-btn--dark1 btn--md show-password">显示</button> -->
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        <label for="customer_tel" class="col-md-3 col-form-label">电话</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="customer_address" class="col-md-3 col-form-label">地址</label>
                        <div class="col-md-6">
...
<%--                                <a href="#" class="for-get">忘记密码？</a>--%>
                                <div class="sign-btn">
                                    <button type="submit" href="#" class="btn theme-btn--dark1 btn--md">注册</button>
                                </div>
                            </div>
                        </div>
                    </div>
