        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-title text-center my-20">
                    <h2 class="title text-dark text-capitalize">购物车</h2>
                </div>
            </div>
            <div class="col-12">
...
<section class="whish-list-section theme1 pb-70">
    <div class="container grid-wraper">
        <div class="row">
            <div class="col-12">
                <h3 class="title pb-25 text-center text-md-left text-capitalize">购物车</h3>
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tr>
                            <th class="text-center" scope="row">
                                <img src="images/cpu1.png" alt="img">
                            </th>
                            <td class="text-center">
                                <span class="whish-title"><%=component.get_detail_name("1")%></span>
                            </td>
                            <td class="text-center">
                                <span class="badge badge-danger position-static my-badge">库存充足</span>
                            </td>
                            <td class="text-center">
                    ...
                    <span class="whish-list-price">
                      <%=component.get_detail_price("1")%>
                            ...
                            <td class="text-center">
                                <a href="buyProduct.jsp" class="btn theme-btn--dark1 btn--xl text-uppercase">下单</a>
                            </td>
                        </tr>
                        <tr>
                            <th class="text-center" scope="row">
                                <img src="assets/img/product/i5-12400F.jpg" alt="img">
                            </th>
                            <td class="text-center">
                                <span class="whish-title">Intel 酷睿 i5-12400F</span>
                            </td>
                            <td class="text-center">
                                <span class="badge badge-danger position-static my-badge">库存充足</span>
                            </td>
                    ...
                    <span class="whish-list-price">
                      ￥1499
                            ...
                            <td class="text-center">
                                <a href="#" class="btn theme-btn--dark1 btn--xl text-uppercase">下单</a>
                            </td>
                        </tr>
                        <tr>
                            <th class="text-center" scope="row">
                                <img src="assets/img/product/RTX3090-Kudan24G.jpg" alt="img">

                            </th>
                            <td class="text-center">
                                <span class="whish-title">RTX3090-Kudan24G</span>
                            </td>
                            <td class="text-center">
                                <span class="badge badge-danger position-static my-badge">库存充足</span>
                            </td>
